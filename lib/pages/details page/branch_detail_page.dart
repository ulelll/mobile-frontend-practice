...
import 'package:mobile_sigma_app/controllers/details page/branch_detail.controller.dart';
...
class BranchDetailPage extends StatelessWidget {
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                ElevatedButton.icon(
                  onPressed: () => controller.fetchBranchDetail(branchId),
  ...
  void _showEditDialog(Map<String, dynamic> data) {
    Get.dialog(
      AlertDialog(
        ...
        content: Text('Edit branch: ${data['name']}?'),
        actions: [
          TextButton(
            onPressed: () => Get.back(),
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            const Text('Are you sure you want to delete this branch?'),
  ...
  void _deleteBranch(Map<String, dynamic> data) {
  ...
  Widget _buildBranchHeader(Map<String, dynamic> data) {
    return Padding(
